	...
	const data: any = {
		job: [
			{
				...
				subject: 'Are the jobs displayed on the site reliable?',
				content: 'of course we only have verified jobs',
			},
			{
			...
			},
			{
				...
				content: 'Simply use our search bar to enter location, price range, experience, and job type.',
			},
			{
			...
			},
			{
				...
				subject: 'What should I consider when buying a job?',
			...
			},
			{
				...
				subject: 'What happens if I encounter issues with the job after purchase?',
				content: 'We offer post-purchase support to address any concerns promptly.',
			},
			{
				id: '00f5a45ed8897f8090116a28',
				subject: 'Do you offer jobs in specific neighborhoods?',
				content: 'Yes, we have listings in various neighborhoods based on your preferences.',
			},
			{
				id: '00f5a45ed8897f8090116a27',
				subject: 'Can I sell my job through your website?',
				content: 'Absolutely, we provide services for selling jobs as well.',
			},
			{
				id: '00f5a45ed8897f8090116b99',
				subject: 'What if I need help understanding legal aspects of job purchase?',
		...
		payment: [
			...
			},
			{
				...
				content: 'Yes, we offer installment payment plans for certain jobs. Please inquire for more details.',
			},
			{
		...
		buyers: [
			{
				...
				content: 'Buyers should check and decide whether the job they want to buy or rent is actually suitable!',
			},
			{
				id: '00f5a45ed8897f8090116a85',
				subject: 'How can I determine if a job is within my budget?',
				content:
			...
			},
			{
				...
				subject: 'What documents do I need to provide when purchasing a job?',
				content:
			...
			},
			{
				...
				subject: 'Can I negotiate the price of a job?',
				content:
					'Yes, you can negotiate the price of a job. Our agents will assist you in making competitive offers and negotiating terms with the seller.',
			},
			{
				id: '00f5a45ed8897f8090116a81',
				subject: 'What are some red flags to watch out for when viewing jobs?',
				content:
			...
			},
			{
				...
				subject: 'Do you provide assistance with job inspections?',
				content:
					'Yes, we can recommend reputable inspectors and accompany you during job inspections to identify any potential issues.',
			},
			{
				id: '00f5a45ed8897f8090116a79',
				subject: 'How long does it typically take to find the right job?',
				content:
					'The timeframe varies depending on your preferences and market conditions. Our agents will work diligently to find the right job as quickly as possible.',
			},
			{
				id: '00f5a45ed8897f8090116a78',
				subject: 'What are the advantages of using a real estate agent when buying a job?',
				content:
			...
			},
			{
				...
				subject: 'What happens if I change my mind about a job after making an offer?',
				content:
		...
		agents: [
			...
			},
			{
				...
				subject: 'What are some effective marketing strategies for selling jobs?',
		...
		membership: [
			...
			},
			{
				...
				subject: 'Do members receive discounts on job listings or services?',
...
return (
			<Stack className={'faq-content'}>
				<Box className={'categories'} component={'div'}>
					<div
						className={category === 'job' ? 'active' : ''}
						onClick={() => {
							changeCategoryHandler('job');
						}}
					>
						Job
					</div>
