...
export const updateUserInfo = (jwtToken: any) => {
	...
	userVar({
		...
		memberResume: claims.memberResume ?? '',
		memberJobs: claims.memberJobs,
		memberCompany: claims.memberCompany ?? '',
		memberJoblistings: claims.memberJoblistings ?? '',
		memberApplications: claims.memberApplications?? '',
