...
const JobDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const [insertCommentData, setInsertCommentData] = useState<CommentInput>({
		commentGroup: CommentGroup.JOB_POST,
		commentContent: '',
		commentRefId: '',
	});
	...
	const {
		...
		skip: !jobId, // jobId mavjud bolmasa mantiq amalga oshmasin
								...
								<Stack className={'left-box'}>
										...
										<Stack className={'buy-rent-box'}>
											{job?.jobNegotiableSalary && (
												<>
													...
													<Typography className={'buy-rent'}>Negotioation</Typography>
												</>
											)}

											{job?.jobRemoteAvailable && (
												<>
													<Stack className={'circle'}>
														<svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6" fill="none">
															<circle cx="3" cy="3" r="3" fill="#EB6753" />
													...
													<Typography className={'buy-rent'}>Remote</Typography>
												</>
											)}
										</Stack>
										<Stack className={'divider'}></Stack>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											<img src="/img/icons/bed.svg" alt="" /> <Typography>{job?.jobExperienceRequired} Expereince</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/room.svg" alt="" /> <Typography>{job?.jobPositionsAvailable} Positions </Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/expand.svg" alt="" /> <Typography>{job?.jobRank} Rank </Typography>
										</Stack>
									</Stack>
								</Stack>
							...
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Expereince</Typography>
											<Typography className={'option-data'}>{job?.jobExperienceRequired}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{job?.jobPositionsAvailable}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{moment(job?.createdAt).format('YYYY')}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{job?.jobRank} Rank </Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{job?.jobEmploymentMode}</Typography>
										</Stack>
									</Stack>
								</Stack>
								<Stack className={'prop-desc-config'}>
									<Stack className={'top'}>
										...
										<Typography className={'desc'}>{job?.jobDescription ?? 'No Description!'}</Typography>
									</Stack>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												<Box component={'div'} className={'info'}>
													...
													<Typography className={'data'}>${formatterStr(job?.jobSalary)}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Job Rank</Typography>
													<Typography className={'data'}>{job?.jobRank} Rank </Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Job Positions Available</Typography>
													<Typography className={'data'}>{job?.jobPositionsAvailable}</Typography>
												</Box>
											</Stack>
											<Stack className={'right'}>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Year Built</Typography>
													<Typography className={'data'}>{moment(job?.createdAt).format('YYYY')}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Job Type</Typography>
													<Typography className={'data'}>{job?.jobEmploymentMode}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>job Options</Typography>
													<Typography className={'data'}>
														For {job?.jobNegotiableSalary && 'Negotiation'} {job?.jobRemoteAvailable && 'Remote'}
													</Typography>
												</Box>
											</Stack>
										</Stack>
								...
								<Stack className={'floor-plans-config'}>
									...
									<Stack className={'image-box'}>
										<img src={'/img/job/floorPlan.png'} alt={'image'} />
									</Stack>
								</Stack>
									...
									<Stack className={'image-info'}>
										...
										<Stack className={'name-phone-listings'}>
											<Link href={`/member?memberId=${job?.memberData?._id}`}>
												<Typography className={'name'}>{job?.memberData?.memberNick}</Typography>
											</Link>
											<Stack className={'phone-number'}>
												...
												<Typography className={'number'}>{job?.memberData?.memberPhone}</Typography>
											</Stack>
							...
							<Stack className={'similar-properties-config'}>
								<Stack className={'title-pagination-box'}>
									<Stack className={'title-box'}>
										<Typography className={'main-title'}>Destination job</Typography>
